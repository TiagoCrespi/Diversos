...
---- Separa��o dos rebuils e reorgs conforme o valor do parametro -----
--- Rebuild ---
...
-- Reaproveita a tabela para o loop para n�o precisar fazer dois loops --
...
begin
	...
	-- Remove o regsitro da tabela tempor�ria --
